        ...
        <form action="post" className="w-full">
          <div className="space-y-2 w-full">
            ...
            <div>
              <button
                type="button"
                className={`border active:scale-95 transition transform duration-100 ease-in-out text-lg font-semibold text-white text-center px-6 w-full h-[56px] bg-gradient-to-r from-Purple to-VividBlue rounded-tl-[30px] rounded-br-[30px] rounded-tr-none rounded-bl-none outline-none`}
                onClick={() => CheckOtp()}
              >
