...
const KeyRisks = () => {
  return (
    <>
      <Helmet>
        <title>Investigo - Key of Success</title>
      </Helmet>
      <Navbar />
      {/* banner */}
      <section
          ...
          <div className="key-faq__area">
            <div className="section__header">
              ...
              <p className="neutral-bottom">
                Investing in property can be rewarding but, as with any
                investment there are risks. The Info Packs and the Investment
                Terms and Conditions cover the risks specific to a particular
                investment but it is also important that, before investing, you
                understand the following general risks..
              </p>
            </div>
